...
<html lang="en">
  ...
  if (document.getElementById('password').value ==
    ...
    document.getElementById('check').style.textAlign = 'center';
        ...
        <div class="col-lg-8 col-md-10 mx-auto">
          <form class="form-signin" method="post" action="sign.php">
            ...
            <fieldset>
              ...
              <div class="controls">
                <input type="password" onkeyup="check()" class="form-control" id="password" name="password" id="password" required="required">
                 </div>
              </div>
              <div class="form-group">     
                <label class="control-label"  for="password">Confirm Password</label>
              <div class="controls">
                <input type="password" id="cpassword" class="form-control" onkeyup="check()" name="cpassword" required="required" >
                 </div>
                 <span id="check"></span>
              </div>
